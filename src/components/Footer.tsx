    ...
    <footer className="bg-bg-elevated py-10 md:py-16 px-5 md:px-10">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 items-start">
        ...
        <div className="flex flex-col">
          ...
          <span className="font-mono text-[11px] md:text-[12px] text-gold tracking-[0.2em] uppercase mt-1">AI App Builders</span>
        </div>
        ...
        <div className="flex flex-wrap gap-4 md:gap-7">
          {[
            ...
            <a
              ...
              className="font-mono text-[14px] md:text-[14px] text-label-text hover:text-foreground transition-colors"
            >
              {link.label}
            </a>
          ))}
        ...
        <div className="md:text-right">
          <span className="font-mono text-[11px] md:text-[12px] text-label-text">© 2026 Ardent Studio</span>
        </div>
      </div>
    </footer>
  </>
