...
const ProcessSection = () => (
  <section id="process" className="relative py-[112px] px-5 md:px-10" style={{ background: "#0A0A08" }}>
    <div className="max-w-[1200px] mx-auto">
      <div className="reveal-section mb-8 md:mb-12">
        <span className="font-mono text-[11px] text-gold tracking-[0.2em] uppercase">How We Work</span>
      </div>
      ...
      <div className="reveal-section grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 mb-16 md:mb-24">
        ...
        <p className="font-mono text-[16px] text-body-text leading-[1.75] self-end">
      ...
      <div className="reveal-section grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        {steps.map((step, i) => (
          ...
          >
            ...
            <h3 className="font-serif text-[22px] font-light text-foreground mt-3 md:mt-4 mb-4 md:mb-5">{step.title}</h3>
            <p className="font-mono text-[14px] text-body-text leading-[1.75] mb-6 md:mb-8">{step.desc}</p>
            <span className="font-mono text-[11px] text-gold">{step.meta}</span>
          </div>
        ))}
      </div>
    </div>
