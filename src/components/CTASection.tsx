...
const CTASection = () => (
  <section id="contact" className="relative py-[112px] px-5 md:px-10 overflow-hidden" style={{ background: "#0A0A08" }}>
    <ParticleCanvas />

    {/* Diagonal gold gradient overlay */}
    <div className="absolute inset-0 pointer-events-none" style={{ background: "linear-gradient(135deg, rgba(196,153,58,0.08) 0%, transparent 50%, rgba(196,153,58,0.04) 100%)" }} />

    {/* Gold top border accent */}
    <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-gold/40 to-transparent" />

    <div className="relative z-10 max-w-[700px] mx-auto text-center reveal-section">
      <span className="block font-mono text-[11px] text-gold tracking-[0.2em] uppercase mb-6">Get Started</span>
      ...
      <p className="font-mono text-[16px] text-body-text max-w-[400px] md:max-w-[460px] mx-auto mb-8 md:mb-12 leading-[1.75]">
