...
const WhatWeBuildSection = () => (
  <section id="services" className="relative py-[112px] px-5 md:px-10" style={{ background: "#0E0E0E" }}>
    ...
    <div className="max-w-[1200px] mx-auto">
      <div className="reveal-section mb-8 md:mb-12">
        <span className="font-mono text-[11px] text-gold tracking-[0.2em] uppercase">What We Build</span>
      </div>
      <div className="reveal-section grid grid-cols-1 md:grid-cols-3">
        {cards.map((card, i) => (
          ...
          >
            ...
            <h3 className="font-serif text-[22px] font-light text-foreground mt-3 md:mt-4 mb-4 md:mb-5">{card.title}</h3>
            <p className="font-mono text-[14px] text-body-text leading-[1.75] mb-6 md:mb-10">{card.desc}</p>
