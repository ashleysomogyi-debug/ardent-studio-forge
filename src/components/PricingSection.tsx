  ...
  <section id="pricing" className="bg-bg-base py-20 px-6 md:py-24 md:px-10">
    <div className="max-w-[1200px] mx-auto">
      ...
      <div className="reveal-section text-center mb-16">
        ...
        <p className="font-mono text-[16px] text-body-text max-w-[480px] mx-auto">
      ...
      <div className="reveal-section border border-border mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="p-6 border-b md:border-b-0 md:border-r border-border">
            ...
            <ul className="space-y-2 font-mono text-[17px] text-body-text">
            ...
            <p className="font-mono text-[16px] text-label-text mt-4 leading-relaxed">
          ...
          <div className="p-6 border-b md:border-b-0 md:border-r border-border">
            ...
            <ul className="space-y-2 font-mono text-[17px] text-body-text mt-4">
      ...
      <div className="reveal-section grid grid-cols-1 md:grid-cols-3 gap-px bg-border mb-12">
        ...
        <div className="bg-bg-base p-10 flex flex-col">
          ...
          <span className="font-mono text-[16px] text-label-text mb-4">fixed fee · 1 week</span>
          <p className="font-mono text-[17px] text-body-text leading-relaxed mb-6">
            Best for: landing pages, single-workflow tools, simple apps with one user type.
          </p>
          <ul className="space-y-2 font-mono text-[17px] text-body-text mb-4">
            <li>One core workflow / one user role</li>
            <li>Up to 3 database tables</li>
            <li>Up to 6 screens</li>
          </ul>
          <p className="font-mono text-[16px] text-label-text/50 mb-8">Auth, mobile layout, deploy, source code</p>
          <a
            href="#contact"
            data-hover
            className="mt-auto font-mono text-[17px] border border-foreground/30 text-foreground px-6 py-3 rounded-full text-center hover:border-foreground/60 transition-colors"
          >
            Book a scope call
          </a>
        </div>
        ...
        <div className="bg-bg-base p-10 flex flex-col relative">
          <span className="absolute top-4 right-4 font-mono text-[17px] bg-gold/20 text-gold px-3 py-1 rounded-full">
            Most Requested
          </span>
          ...
          <span className="font-mono text-[16px] text-label-text mb-4">from · 1–3 weeks</span>
          <p className="font-mono text-[17px] text-body-text leading-relaxed mb-6">
          ...
          <a
            href="#contact"
            data-hover
            className="mt-auto font-mono text-[17px] bg-foreground text-bg-base px-6 py-3 rounded-full text-center hover:opacity-90 transition-opacity"
          >
            Book a scope call
          </a>
        </div>
        ...
        <div className="bg-bg-base p-10 flex flex-col">
          ...
          <span className="font-mono text-[16px] text-label-text mb-4">fixed fee · 48–72 hrs</span>
          <p className="font-mono text-[17px] text-body-text leading-relaxed mb-6">
          ...
          <p className="font-mono text-[16px] text-label-text/50 mb-8">Source code, walkthrough</p>
          <a
            href="#contact"
            data-hover
            className="mt-auto font-mono text-[17px] border border-foreground/30 text-foreground px-6 py-3 rounded-full text-center hover:border-foreground/60 transition-colors"
      ...
      <div className="reveal-section flex flex-col md:flex-row items-start md:items-center justify-between border border-border p-6 gap-4">
        <p className="font-mono text-[17px] text-body-text">
