...
const PricingSection = () => (
  <section id="pricing" className="py-[112px] px-5 md:px-10" style={{ background: "#0E0E0E" }}>
    <div className="max-w-[1200px] mx-auto">
      {/* Header */}
      <div className="reveal-section text-center mb-12 md:mb-20">
        <span className="block font-mono text-[11px] text-gold tracking-[0.2em] uppercase mb-6">Pricing</span>
        ...
        <p className="font-mono text-[16px] text-body-text max-w-[480px] mx-auto leading-[1.75]">
      ...
      <div className="reveal-section border border-border mb-10 md:mb-16">
        <div className="p-5 md:p-7 border-b border-border">
          <span className="font-mono text-[16px] text-label-text">Which tier is your project?</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3">
          <div className="p-5 md:p-7 border-b md:border-b-0 md:border-r border-border">
            ...
            <ul className="space-y-2.5 md:space-y-3 font-mono text-[14px] text-body-text">
          ...
          <div className="p-5 md:p-7 border-b md:border-b-0 md:border-r border-border">
            ...
            <span className="font-mono text-[14px] text-gold">$2,500</span>
            <ul className="space-y-2.5 md:space-y-3 font-mono text-[14px] text-body-text mt-4 md:mt-5">
          ...
          <div className="p-5 md:p-7">
            ...
            <span className="font-mono text-[14px] text-gold">from $6,500</span>
            <ul className="space-y-2.5 md:space-y-3 font-mono text-[14px] text-body-text mt-4 md:mt-5">
      ...
      {/* Pricing cards */}
      <div className="reveal-section grid grid-cols-1 md:grid-cols-3 gap-px mb-10 md:mb-16" style={{ background: "rgba(196,153,58,0.2)" }}>
        {/* Starter */}
        <div className="p-8 md:p-12 flex flex-col" style={{ background: "#0E0E0E" }}>
          ...
          <p className="font-mono text-[16px] text-body-text leading-[1.75] mb-6 md:mb-8">
            Best for: landing pages, single-workflow tools, simple apps with one user type.
          </p>
          <ul className="space-y-2.5 md:space-y-3 font-mono text-[14px] text-body-text mb-4 md:mb-5">
        ...
        {/* Business Tool — featured with gold border + tint */}
        <div className="p-8 md:p-12 flex flex-col relative" style={{ background: "linear-gradient(180deg, rgba(196,153,58,0.08) 0%, #0E0E0E 40%)", border: "1px solid rgba(196,153,58,0.35)" }}>
          <span className="absolute top-3 right-3 md:top-4 md:right-4 font-mono text-[11px] bg-gold/20 text-gold px-3 py-1 rounded-full">
            Most Requested
          </span>
          ...
          <div className="mt-2 md:mt-3 mb-1">
            ...
            <span className="font-mono text-[14px] text-label-text ml-1">+</span>
          </div>
      ...
      <div className="reveal-section flex flex-col md:flex-row items-start md:items-center justify-between border border-border p-5 md:p-7 gap-3 md:gap-4">
        <p className="font-mono text-[16px] text-body-text leading-[1.75]">
        ...
        <span className="font-mono text-[14px] text-gold whitespace-nowrap">From $300 / month</span>
      </div>
    </div>
  </section>
);
