      ...
      <main>
        ...
        <section className="relative pt-[140px] pb-[80px] md:pt-[180px] md:pb-[112px] px-5 md:px-10 overflow-hidden" style={{ background: "var(--color-bg)" }}>
          ...
          <div className="relative z-10 max-w-[800px] mx-auto text-center reveal-section">
            <span className="block font-mono text-[11px] text-teal tracking-[0.2em] uppercase mb-6">Ardent Studio</span>
        ...
        <section className="py-[80px] md:py-[112px] px-5 md:px-10" style={{ background: "var(--color-surface-2)" }}>
          <div className="max-w-[1200px] mx-auto">
            <div className="reveal-section mb-10 md:mb-14">
              <span className="font-mono text-[11px] text-teal tracking-[0.2em] uppercase">What's Included</span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="reveal-section rounded-lg p-6 md:p-8 border border-border-subtle hover:border-teal/30 transition-colors"
                  style={{ background: "var(--color-surface)" }}
                >
                  <span className="text-teal text-[16px] mb-4 block">◈</span>
          ...
          <>
            <section className="py-[64px] md:py-[80px] px-5 md:px-10" style={{ background: "var(--color-bg)" }}>
              <div className="max-w-[800px] mx-auto text-center reveal-section">
                <span className="font-mono text-[11px] text-teal tracking-[0.2em] uppercase mb-6 block">Industries We Serve</span>
          ...
          <>
            <section className="py-[80px] md:py-[112px] px-5 md:px-10" style={{ background: "var(--color-surface)" }}>
              <div className="max-w-[700px] mx-auto reveal-section">
                <span className="font-mono text-[11px] text-teal tracking-[0.2em] uppercase mb-6 block">Case Study</span>
                <div className="border-l-2 border-teal/40 pl-8 md:pl-10">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-teal text-[14px] font-mono">Result:</span>
        ...
        <section className="py-[80px] md:py-[112px] px-5 md:px-10" style={{ background: "var(--color-surface-2)" }}>
          <div className="max-w-[800px] mx-auto">
            <div className="reveal-section mb-10">
              <span className="font-mono text-[11px] text-teal tracking-[0.2em] uppercase">Why Ardent Studio</span>
            </div>
            <div className="flex flex-col gap-6">
              {whyArdent.map((point, i) => (
                <div key={i} className="reveal-section flex gap-4">
                  <span className="text-teal text-[16px] mt-0.5 shrink-0">◈</span>
