...
const SelectedWorkSection = () => (
  <section id="work" className="bg-bg-elevated py-16 px-5 md:py-32 md:px-10">
    <div className="max-w-[1200px] mx-auto">
      <div className="reveal-section mb-8 md:mb-12">
        <span className="font-mono text-[14px] md:text-[16px] text-gold tracking-[0.2em] uppercase">Selected work</span>
      </div>
        ...
        {works.map((w) => {
          ...
          return (
            ...
            >
              ...
              <span className="font-mono text-[14px] md:text-[16px] text-label-text">{w.num}</span>
              <div>
                <span className="font-serif text-[20px] md:text-[22px] text-foreground">{w.name}</span>
                <p className="font-mono text-[14px] md:text-[17px] text-body-text mt-1 md:mt-2 leading-[1.6] md:leading-[1.7]">{w.desc}</p>
