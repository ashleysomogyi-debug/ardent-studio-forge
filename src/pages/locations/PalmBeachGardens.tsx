...
const CITY = "Palm Beach Gardens";
const SLUG = "palm-beach-gardens";
const META_TITLE = "AI Automation for Palm Beach Gardens Businesses | Ardent Studio";
const META_DESC =
  "AI automation services in Palm Beach Gardens, FL. Custom workflows and chatbots for medical practices, corporate offices, retail, and professional services. Book a free call.";
...
const PalmBeachGardens = () => {
  ...
  return (
    <ServicePageLayout
      ...
      caseStudy={{
        title: "Palm Beach Gardens Medical Practice",
        description:
          "A multi-provider medical practice in Palm Beach Gardens needed to automate patient intake, appointment reminders, and post-visit follow-up surveys.",
        result: "Patient communication fully automated. Front desk hours reduced by 12/week.",
      }}
    />
  );
};
